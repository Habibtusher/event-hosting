        ...
        <div className="flex flex-col md:flex-row justify-between pt-10 pb-10">
          ...
          <div className="w-full md:w-1/2 mt-8 md:mt-0">
            <div className="md:ml-[10rem]">
              ...
              <input
                className=" mt-2 mb-2 bg-black border border-gray-300 text-gray-900 text-sm rounded-md  block w-full p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                type="text"
